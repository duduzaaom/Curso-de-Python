...
def passed_students(attempts: list, course: str):
    passed_attempts = list(filter(lambda attempt: attempt.grade > 0 and attempt.course_name == course, attempts))
    
    return sorted(list(map(lambda attempt: attempt.student_name, passed_attempts)))
